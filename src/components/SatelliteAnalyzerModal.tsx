      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden">
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2.5 mb-3">
              {SATELLITE_PRESETS.map(preset => (
                ...
                >
                  ...
                  <p className="text-[10px] text-slate-400 font-mono mt-0.5">{preset.sensor}</p>
                </button>
              ))}
            </div>
            ...
            <div className="flex items-center gap-3">
              <label className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-dashed border-slate-700 hover:border-cyan-500/60 bg-slate-950/40 text-slate-300 hover:text-white text-xs font-semibold cursor-pointer transition-all">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-5 items-start">
            ...
            <div className="md:col-span-5 relative rounded-xl overflow-hidden border border-slate-800 bg-slate-950">
              <img
                src={activeImageUrl}
                alt="Active Satellite Preview"
                className="w-full h-56 object-cover"
              />
              <div className="absolute top-2 left-2 px-2 py-0.5 rounded bg-slate-950/80 backdrop-blur-md border border-slate-700 text-[10px] font-mono text-cyan-300 flex items-center gap-1.5">
                <Activity className="w-3 h-3 text-cyan-400 animate-pulse" />
                {selectedPresetId === 'custom' ? sensorType : currentPreset?.sensor}
              </div>
              <div className="absolute bottom-2 left-2 right-2 px-2.5 py-1.5 rounded bg-slate-950/90 backdrop-blur-md border border-slate-800 text-[11px] text-slate-300">
            ...
            <div className="md:col-span-7 space-y-4">
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-slate-950 font-bold text-sm shadow-lg shadow-cyan-500/20 flex items-center justify-center gap-2 transition-all disabled:opacity-50 cursor-pointer"
              >
                {isAnalyzing ? (
                  <>
          ...
          {analysisResult && (
            <div className="p-5 rounded-xl bg-slate-950/80 border border-cyan-500/40 shadow-xl space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
              ...
              <div className="pt-3 border-t border-slate-800 flex justify-end">
                <button
                  ...
                  className="px-5 py-2.5 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold text-xs flex items-center gap-2 shadow-lg shadow-cyan-500/20 cursor-pointer transition-all"
                >
